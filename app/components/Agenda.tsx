                  ...
                  return (
                    <div key={key} style={{ display: 'flex', alignItems: 'center', padding: '10px 14px', borderBottom: '1px solid var(--border)', gap: 12, background: bg }}>
                      ...
                      <div style={{ display: 'flex', gap: 5 }}>
                        ...
                        <button onClick={() => askConfirm('Remover recorrência', `Remover a recorrência de ${c.nome}?`, () => { delAgenda(s.agendaId); showToast('Removida'); })} style={{ padding: '4px 8px', borderRadius: 4, fontSize: 10, cursor: 'pointer', border: '1px solid var(--border)', background: 'none', color: 'var(--muted)' }}>🗑</button>
                      </div>
                    </div>
                  );
                })}
                  ...
                  return (
                    <div key={e.id} style={{ display: 'flex', alignItems: 'center', padding: '10px 14px', borderBottom: '1px solid var(--border)', gap: 12, background: bg }}>
                      ...
                      <div style={{ display: 'flex', gap: 5 }}>
                        ...
                        <button onClick={() => askConfirm('Remover agenda extra', `Remover agenda extra de ${c.nome}?`, () => { delAgendaExtra(e.id); showToast('Removida'); })} style={{ padding: '4px 8px', borderRadius: 4, fontSize: 10, cursor: 'pointer', border: '1px solid var(--border)', background: 'none', color: 'var(--muted)' }}>🗑</button>
                      </div>
                    </div>
                  );
                })}
                  ...
                  return (
                    <div key={key} style={{ display: 'flex', alignItems: 'center', padding: '10px 14px', borderBottom: '1px solid var(--border)', gap: 12, background: bg }}>
                      ...
                      <div style={{ display: 'flex', gap: 5 }}>
                        ...
                        <button onClick={() => askConfirm('Remover scan', `Remover scan de ${c.nome}?`, () => { delScan(s.scanId); showToast('Removido'); })} style={{ padding: '4px 8px', borderRadius: 4, fontSize: 10, cursor: 'pointer', border: '1px solid var(--border)', background: 'none', color: 'var(--muted)' }}>🗑</button>
                      </div>
                    </div>
                  );
                })}
